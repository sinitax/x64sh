...
Some changes made by Sinitax (diff to original examples/xed-asmparse.c)
...
static int __attribute__((warn_unused_result)) grab_decorator(char* s, unsigned int pos, char** optr);
static bool __attribute__((warn_unused_result)) parse_reg(xed_enc_line_parsed_t* v, char* s, opnd_list_t* onode);
static bool __attribute__((warn_unused_result)) parse_decorator(char* s, opnd_list_t* onode);
static bool __attribute__((warn_unused_result)) parse_memref(char* s, opnd_list_t* onode);
static bool __attribute__((warn_unused_result)) refine_operand(xed_enc_line_parsed_t* v, char* s);
static bool __attribute__((warn_unused_result)) refine_operands(xed_enc_line_parsed_t* v);
...
static bool parse_reg(xed_enc_line_parsed_t* v, char* s, opnd_list_t* onode)
{
	char tbuf[BLEN];
	unsigned int i=0;
	unsigned int len=0;
...
static bool parse_decorator(char* s, opnd_list_t* onode)
{
	unsigned int i=0;
	unsigned int len=0;
...
static bool parse_memref(char* s, opnd_list_t* onode)
{
...
static bool refine_operand(xed_enc_line_parsed_t* v, char* s)
{
...
static bool refine_operands(xed_enc_line_parsed_t* v)
{
	slist_t* p = 0;
	if (v->operands) {
...
bool asp_parse_line(xed_enc_line_parsed_t* v)
{
